...
if core.get_modpath("unified_inventory") then
	if core.get_all_craft_recipes("unified_inventory:bag_large") ~= nil then
...
if core.get_modpath("fire") then
	...
	if core.settings:get_bool("disable_fire") ~= true then
...
if core.get_modpath("default") then
	...
	awards.register_on_dig(function(player,data)
		local pos = player:get_pos()
		if pos and (core.find_node_near(pos, 1, "default:lava_source") or
				core.find_node_near(pos, 1, "default:lava_flowing")) then
	...
	awards.register_on_death(function(player,data)
		local pos = player:get_pos()
		if pos and (core.find_node_near(pos, 2, "default:lava_flowing") ~= nil or
				core.find_node_near(pos, 2, "default:lava_source") ~= nil) then
...
if core.get_modpath("wool") and core.get_modpath("farming") then
