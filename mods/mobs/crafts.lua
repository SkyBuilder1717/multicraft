...
local mc2 = minetest.get_modpath("mcl_minetest")
local mod_def = minetest.get_modpath("default")
local hunger = minetest.get_modpath("hunger")
...
minetest.register_craftitem("mobs:meat", {
	...
	on_use = function(itemstack, player, pointed_thing)
		return minetest.do_item_eat(8, "", itemstack, player, pointed_thing)
	end
})
...
minetest.register_craftitem("mobs:chicken_cooked", {
	...
	groups = {food_meat = 1, food = 1},
	on_use = function(itemstack, player, pointed_thing)
		return minetest.do_item_eat(7, "", itemstack, player, pointed_thing)
	end
})
...
minetest.register_craftitem("mobs:rabbit_cooked", {
	...
	groups = {food_meat = 1, food = 1},
	on_use = function(itemstack, player, pointed_thing)
		return minetest.do_item_eat(4, "", itemstack, player, pointed_thing)
	end
})
...
minetest.register_craftitem("mobs:pork_cooked", {
	...
	groups = {food_meat = 1, food = 1},
	on_use = function(itemstack, player, pointed_thing)
		return minetest.do_item_eat(5, "", itemstack, player, pointed_thing)
	end
})
