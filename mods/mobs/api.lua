...
function mob_class:do_jump()
	...
	if core.registered_nodes[self.standing_on].walkable == false then
		return false
	end
	...
	and (self.walk_chance == 0 or core.registered_items[self.looking_at].walkable)
...
function mobs:register_egg(mob, desc, background, addegg, no_creative)
	...
	if addegg == 1 then
		invimg = "mobs_egg_overlay.png^(" .. invimg .. "^[mask:mobs_chicken_egg_overlay.png)"
	end
