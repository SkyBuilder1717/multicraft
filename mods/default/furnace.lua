...
function default.get_furnace_active_formspec(pos, fuel_percent, item_percent)
	return "size[9,8.75]"..
		...
		"list[nodemeta:"..pos.x..","..pos.y..","..pos.z..";src;3,0.5;1,1;]"..
		"list[nodemeta:"..pos.x..","..pos.y..","..pos.z..";fuel;3,2.5;1,1;]"..
		"list[nodemeta:"..pos.x..","..pos.y..","..pos.z..";dst;5,1.5;1,1;]"..
		"list[detached:split;main;8,3.14;1,1;]"..
		"image[4,1.65;1,0.75;formspec_furnace_arrow.png^[lowpart:"..(item_percent)..":formspec_furnace_arrow_active.png^[transformR270]"..
...
function default.get_furnace_inactive_formspec(pos)
	return 	"size[9,8.75]"..
		...
		default.gui_bg..
		default.listcolors..
		"image[4,1.65;1,0.75;formspec_furnace_arrow.png^[transformR270]"..
		"image_button_exit[8.4,-0.1;0.75,0.75;close.png;exit;;true;false;close_pressed.png]"..
		"list[current_player;main;0,4.5;9,3;9]"..
		"list[current_player;main;0,7.74;9,1;]"..
		"list[nodemeta:"..pos.x..","..pos.y..","..pos.z..";src;3,0.5;1,1;]"..
...
local function can_dig(pos, player)
	...
	core.add_item(pos, inv:get_stack("fuel", 1))
	core.add_item(pos, inv:get_stack("dst", 1))
	core.add_item(pos, inv:get_stack("src", 1))
	return true
end
...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = default.get_furnace_active_formspec(pos, fuel_percent, item_percent)
		...
		formspec = default.get_furnace_inactive_formspec(pos)
