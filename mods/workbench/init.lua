...
local formspecs = {
	...
	[[	background[-0.2,-0.26;9.41,9.49;formspec_workbench_crafting.png]
		...
		button[0,2;2,1;craftpreview;]
		image[0.6,2.1;0.8,0.8;workbench_craftbook.png]
...
function workbench.fields(pos, _, fields, sender)
	...
	elseif	fields.craftpreview	then
		craftpreview.show_formspec(sender:get_player_name())
...
function workbench.timer(pos)
	...
	tool:add_wear(-500)
	hammer:add_wear(700)
	core.sound_play("workbench_hammer", {pos=pos, max_hear_distance=8})
