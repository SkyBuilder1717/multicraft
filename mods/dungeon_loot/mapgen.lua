...
local function populate_chest(pos, rand, dungeontype)
	--core.chat_send_all("chest placed at " .. core.pos_to_string(pos) .. " [" .. dungeontype .. "]")
...
core.register_on_generated(function(minp, maxp, blockseed)
	...
	for _, room in ipairs(rooms) do
		...
		if core.get_node(chestpos).name == "air" then
			-- make it face inwards to the room
			local facedir = core.dir_to_facedir(vector.multiply(wall.facing, -1))
			core.add_node(chestpos, {name = "default:chest", param2 = facedir})
